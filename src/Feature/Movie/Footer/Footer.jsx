...
function Footer() {
  return (
    ...
    {/* <!-- Copyright --> */}
    <div class="text p-3 footerColor" style={{ textDecoration: 'none', color: 'black' }}>
      © 2022 Copyright:
      <a href='https://mjvirus.netlify.app/' style={{ textDecoration: 'none', color: 'black' }} className='text'> Mjvirusofficial.com</a>
    </div>
    {/* <!-- Copyright --> */}
  </footer>
    </div>
